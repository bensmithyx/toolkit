...
def scanner(ip,portranges):
    top_100_ports = [20,21,22,23,25,53,80,110,111,135,139,143,443,445,993,995,1723,3306,3389,5900,8080,8000]
    ...
    if portranges == "top-100-ports":
        portrange = top_100_ports
                ...
                if option == 1:
                    ...
                    while True:
                        ...
                        if choice == 1:
                            ...
                            portranges = ["top-100-ports","top-1000-ports","all-ports","Exit"]
